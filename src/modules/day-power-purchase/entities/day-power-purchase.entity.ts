...
export class DayPowerPurchase {
  ...
  @Field(() => ReservoirSituationData)
  @Prop({ type: ReservoirSituationData })
  reservoirSituation: ReservoirSituationData;

  @Field(() => MachinesAvailabilityData)
  @Prop()
  machinesAvailability: MachinesAvailabilityData;

  @Field(() => WaterDischargeData)
  @Prop()
...
export const DayPowerPurchaseSchema =
  SchemaFactory.createForClass(DayPowerPurchase);
