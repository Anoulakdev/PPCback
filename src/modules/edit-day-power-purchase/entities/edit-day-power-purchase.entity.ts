...
@ObjectType()
@Schema({
  collection: 'edit_day_power_purchase',
  timestamps: true,
})
export class EditDayPowerPurchase {
  @Field(() => ID)
  _id: string;
  @Field(() => Date)
  createdAt: Date;
...
export const EditDayPowerPurchaseSchema =
  SchemaFactory.createForClass(EditDayPowerPurchase);
